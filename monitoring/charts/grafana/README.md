...
| `image.digest`                               | Image sha (optional)                          | ``                                                      |
...
| `initChownData.image.digest`                 | init-chown-data container image sha (optional)| `""`                                                    |
...
| `sidecar.image.digest`                       | Sidecar image sha (optional)                  | `""`                                                    |
...
| `downloadDashboardsimage.digest`             | Curl docker image sha (optional)              | `""`                                                    |
...
| `imageRenderer.image.digest`                  | image-renderer Image sha (optional)                                                | `""`                             |
