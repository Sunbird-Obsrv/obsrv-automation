...
{{- printf "%s/%s:%s@%s" .Values.global.image.registry .Values.image.repository (default (printf "v%s" .Chart.AppVersion) .Values.image.tag) .Values.image.digest }}
{{- else }}
...
{{- else }}
{{- if .Values.global.image.registry }}
{{- printf "%s/%s:%s" .Values.global.image.registry .Values.image.repository (default (printf "v%s" .Chart.AppVersion) .Values.image.tag) }}
{{- else }}
...
{{- if .Values.global.image.registry }}
{{- printf "%s/%s:%s@%s" .Values.global.image.registry .Values.kubeRBACProxy.image.repository (default (printf "v%s" .Chart.AppVersion) .Values.kubeRBACProxy.image.tag) .Values.kubeRBACProxy.image.digest }}
{{- else }}
...
{{- else }}
{{- if .Values.global.image.registry }}
{{- printf "%s/%s:%s" .Values.global.image.registry .Values.kubeRBACProxy.image.repository (default (printf "v%s" .Chart.AppVersion) .Values.kubeRBACProxy.image.tag) }}
{{- else }}
